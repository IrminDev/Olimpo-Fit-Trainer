...
<body>
	<header class="cabecera">
            ...
            <ul class="navegador">
                ...
                <li><a href="../../../admin/logout.jsp">Cerrar sesi&#243;n</a></li>
            </ul>
    </header>
            ...
            <div class="formulario">
                ...
                <form action="../../../procesosU" method="POST">
                    ...
                    <div class="entrada" id="cidentifier">
                            <h3 class="titulo">Id (No modificable)</h3>
                            <input type="number" placeholder="id" name="id" id="id" value=<% out.print(id); %> readonly>
                            <input type="hidden" placeholder="tipo" name="tipo" id="tipo" value=<% out.print(tipo); %> readonly>
