            ...
            <div class="formulario">
                ...
                <form action="../../../procesosU" method="POST">
                    ...
                    <div class="entrada" id="cmail">
                            <h3 class="titulo">Correo (No modificable)</h3>
                            <input type="email" placeholder="Correo" value="<% out.print(correo); %>" name="correo" id="correo" readonly>
                    </div>					
                    ...
                    <div class="entrada" id="cidentifier">
                            ...
                            <input type="number" placeholder="tipo" name="tipo" id="tipo" value=<% out.print(tipo); %> readonly>
                    </div>
